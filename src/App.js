...
const {
  _REACT_APP_FIREBASE_API_KEY: apiKey,
  _REACT_APP_FIREBASE_AUTH_DOMAIN: authDomain,
  _REACT_APP_FIREBASE_DATABASE_URL: databaseURL,
  _REACT_APP_FIREBASE_PROJECT_ID: projectId,
  _REACT_APP_FIREBASE_STPRAGE_BUCKET: storageBucket,
  _REACT_APP_FIREBASE_MESSAGING_SENDER_ID: messagingSenderId,
  _REACT_APP_FIREBASE_APP_ID: appId,
} = process.env;
